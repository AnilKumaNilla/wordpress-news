 ...
 *
 */
if( !function_exists( 'education_base_add_metabox' )):
    function education_base_add_metabox() {
        add_meta_box(
            'education_base_meta_fields', // $id
            __( 'Featured Icon', 'education-base' ), // $title
            'education_base_meta_fields_callback', // $callback
            'page', // $page
            'side', // $context
            'core'// $priority
        );
...
add_action('add_meta_boxes', 'education_base_add_metabox');
 ...
 *
 */
if ( !function_exists('education_base_meta_fields_callback') ) :
    function education_base_meta_fields_callback(){
        global $post;
