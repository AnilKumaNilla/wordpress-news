...
$wp_customize->add_section( 'education-base-design-sidebar-layout-option', array(
    ...
    'theme_supports' => '',
    'title'          => __( 'Default Sidebar Layout', 'education-base' ),
...
$wp_customize->add_control( 'education_base_theme_options[education-base-sidebar-layout]', array(
    'choices'  	=> $choices,
    'label'		=> __( 'Default Sidebar Layout', 'education-base' ),
    'description'=> __( 'Generally home/front page does not have sidebar', 'education-base' ),
